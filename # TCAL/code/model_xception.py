...
class EntryStem(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        self.Conv2d_8_res = ResidualNet(128,256, activation=True)
        self.Conv2d_9_res = ResidualNet(256,728, activation=True)
...
class ExitStem(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        self.Conv2d_3a = nn.Conv2d(in_channels, 1024, kernel_size=1, stride=2)
        ...
        self.Conv2d_4 = SeperableConv2d(1024, 1536, activation=False)
        self.Conv2d_5 = SeperableConv2d(1536, 2048, activation=True)
        
    def forward(self, x):
        residual = self.Conv2d_3a(x)
        residual = nn.BatchNorm2d(1024, eps=0.001)(residual)
...
class SeperableConv2d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, activation=True, **kwards):
        ...
        self.conv_3x3 = BasicConv2d(in_channels, out_channels, kernel_size = 3, padding = 1)
        self.conv_1x1 = BasicConv2d(out_channels, out_channels, kernel_size=1)
        self.bn = nn.BatchNorm2d(out_channels, eps=0.001)
